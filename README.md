...
* 참고: 해당 링크로 포스트맨을 확인할 수 있습니다. (단, 스크립트, 환경변수 등을 확인하시려면 /postman/movie.postman_collection.json 파일을 다운받으셔야 합니다.) 
...
| 영화 목록 조회 / 검색      | ✅         | ✅           |
| 영화 상세 정보 조회        | ✅         | ✅           |
| 리뷰 작성 / 수정 / 삭제    | ✅ (본인 것만) | ✅(수정: 본인 것만, 삭제: 전체 가능) 
| 리뷰 좋아요 / 북마크       | ✅         | ✅           |
| 영화 데이터 Sync (TMDB) | ❌         | ✅           |
| 영화 생성 / 수정 / 삭제    | ❌         | ✅           |
| 장르 생성 / 수정 / 삭제    | ❌         | ✅           |
| 회원 관리 (조회 / 차단 / 권한 및 상태변경)    | ❌         | ✅           |
